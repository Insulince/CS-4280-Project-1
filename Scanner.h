...
private:
    ...
    const int FSA_TABLE_ROW_INDEX_DELIMITER_LEFT_PARANTHESIS = 19;
    const int FSA_TABLE_ROW_INDEX_DELIMITER_RIGHT_PARANTHESIS = 20;
    ...
    const std::map<TOKEN_IDENTIFIER, int> TOKEN_IDENTIFIER_TO_FSA_TABLE_ROW_INDEX_MAP = {
            ...
            {DELIMITER_LEFT_PARANTHESIS,        FSA_TABLE_ROW_INDEX_DELIMITER_LEFT_PARANTHESIS},
            {DELIMITER_RIGHT_PARANTHESIS,       FSA_TABLE_ROW_INDEX_DELIMITER_RIGHT_PARANTHESIS},
    ...
    const int QUANTITY_CHARACTER_CLASSES = 23;
    ...
    const int FSA_TABLE_COLUMN_INDEX_LEFT_PARANTHESIS = 16;
    const int FSA_TABLE_COLUMN_INDEX_RIGHT_PARANTHESIS = 17;
    ...
    const std::map<char, int> CHARACTER_TO_FSA_TABLE_COLUMN_INDEX_MAP = {
            ...
            {'(', FSA_TABLE_COLUMN_INDEX_LEFT_PARANTHESIS},
            {')', FSA_TABLE_COLUMN_INDEX_RIGHT_PARANTHESIS},
    ...
    const int FINAL_STATE_DELIMITER_LEFT_PARANTHESIS = 1019;
    const int FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS = 1020;
    ...
    const int INTERMEDIATE_STATE_END_OF_FILE = 0;
    ...
    const int INTERMEDIATE_STATE_DELIMITER_LEFT_PARANTHESIS = 19;
    const int INTERMEDIATE_STATE_DELIMITER_RIGHT_PARANTHESIS = 20;
    ...
    const int FSA_TABLE[QUANTITY_TOKENS][QUANTITY_CHARACTER_CLASSES] = {
            ...
            {FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,               FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,                FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS,         FINAL_STATE_DELIMITER_LEFT_PARANTHESIS, FINAL_STATE_DELIMITER_LEFT_PARANTHESIS, FINAL_STATE_DELIMITER_LEFT_PARANTHESIS, FINAL_STATE_DELIMITER_LEFT_PARANTHESIS},
            {FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,              FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,               FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS,        FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS, FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS, FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS, FINAL_STATE_DELIMITER_RIGHT_PARANTHESIS},
